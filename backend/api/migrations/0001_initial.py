# Generated by Django 5.2.1 on 2025-07-03 14:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(db_column='nombre', max_length=150, verbose_name='nombre')),
                ('last_name', models.CharField(db_column='apellido', max_length=150, verbose_name='apellido')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sucursal_devolucion', models.ForeignKey(blank=True, db_column='ID_Sucursal_Devolucion', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='alquileres_devolucion', to='api.sucursal')),
