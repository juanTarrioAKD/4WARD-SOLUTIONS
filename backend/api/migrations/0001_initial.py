    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='alquileres', to=settings.AUTH_USER_MODEL)),
                ('estado', models.ForeignKey(db_column='IDEstado', on_delete=django.db.models.deletion.CASCADE, to='api.estadoalquiler')),
                ('vehiculo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='alquileres', to='api.vehiculo')),
            ],
            options={
                'db_table': 'alquiler',
            },
